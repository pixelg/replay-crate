        ...
        <BaseDialog.Popup className={popup}>
          <div className="flex items-start gap-3">
            <div className="min-w-0 flex-1">
              ...
              {description && (
                <BaseDialog.Description className="mt-1 text-sm text-fg-muted">{description}</BaseDialog.Description>
              )}
            </div>
            <BaseDialog.Close
              aria-label="Close"
              className="-m-1 rounded-full p-1 text-fg-muted hover:bg-surface-sunken hover:text-fg focus-visible:outline-2 focus-visible:outline-accent"
            >
      ...
      <AlertDialog.Portal>
        ...
        <AlertDialog.Popup className={popup}>
          <div>
            ...
            <AlertDialog.Description className="mt-1 text-sm text-fg-muted">{description}</AlertDialog.Description>
          </div>
