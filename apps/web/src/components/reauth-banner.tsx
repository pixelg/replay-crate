...
export function ReauthBanner({ onReconnect }: { onReconnect: () => void }) {
  return (
    <div
      role="status"
      className="flex flex-wrap items-center gap-x-4 gap-y-2 border-b border-border bg-surface-raised px-4 py-3 text-sm md:px-8"
    >
      <TriangleAlert aria-hidden className="size-5 shrink-0 text-accent" />
